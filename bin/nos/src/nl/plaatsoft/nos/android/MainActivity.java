...
public class MainActivity extends BaseActivity {
    ...
    private void fetchNewsData(
        FetchDataTask fetchDataTask, ArticlesAdapter articlesAdapter, String rssUrl, boolean loadFromCache) {
        try {
            fetchDataTask = new FetchDataTask(this,
                "https://api.rss2json.com/v1/api.json?rss_url=" + URLEncoder.encode(rssUrl, "UTF-8")
                    + "&api_key=" + Config.API_KEY + "&count=20",
                loadFromCache, true, (String data) -> {
                    try {
