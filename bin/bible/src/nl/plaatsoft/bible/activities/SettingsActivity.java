...
public class SettingsActivity extends BaseActivity {
    public static final String STORE_PAGE_URL = "https://github.com/bplaat/android-apps/tree/master/bin/bible";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.settings_font_button).setOnClickListener(view -> {
            var alertDialog = new AlertDialog.Builder(this)
                                  ...
                                  .setSingleChoiceItems(fonts, font,
                                      (dialog, which) -> {
                                          dialog.dismiss();
                                          if (font != which) {
                                              font = which;
        ...
        var languages = Arrays.asList(
            Settings.LANGUAGE_ENGLISH, Settings.LANGUAGE_DUTCH, Settings.LANGUAGE_GERMAN, Settings.LANGUAGE_SYSTEM);
        var labels = new String[] {getResources().getString(R.string.settings_language_english),
        ...
        findViewById(R.id.settings_language_button).setOnClickListener(view -> {
            var alertDialog = new AlertDialog.Builder(this)
                                  ...
                                  .setSingleChoiceItems(labels, languages.indexOf(language),
                                      (dialog, which) -> {
                                          dialog.dismiss();
