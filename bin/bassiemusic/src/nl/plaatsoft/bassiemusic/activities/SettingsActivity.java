...
public class SettingsActivity extends BaseActivity {
    public static final String STORE_PAGE_URL =
        "https://play.google.com/store/apps/details?id=nl.plaatsoft.bassiemusic";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Back button
        ((ImageButton)findViewById(R.id.settings_back_button)).setOnClickListener(v -> { finish(); });
        ...
        fastScrollSwitch.setOnCheckedChangeListener(
            (CompoundButton buttonView, boolean isChecked) -> { settings.setFastScroll(isChecked); });
