...
public class SettingsScreen extends Component {
    public static final String STORE_PAGE_URL = "https://github.com/bplaat/android-apps/tree/master/bin/coinlist";
    ...
    public SettingsScreen(Context context) {
        ...
        try {
            ...
            Log.e(context.getPackageName(), "Can't get app version", exception);
        }
    }
    ...
    public void render() {
        ...
        var currencies = context.getResources().getStringArray(R.array.settings_currencies);
        var languages = new String[] {context.getString(R.string.settings_language_english),
            context.getString(R.string.settings_language_dutch), context.getString(R.string.settings_language_system)};
        ...
        new Column(() -> {
            ...
            new Column(() -> {
                ...
                settingsRow(R.drawable.ic_cash_multiple, R.string.settings_currency_button, currencies[currency],
                    () -> showCurrencyDialog(currencies));
                settingsRow(R.drawable.ic_web, R.string.settings_language_button, languages[language],
                    () -> showLanguageDialog(languages));
                settingsRow(R.drawable.ic_invert_colors, R.string.settings_theme_button, themes[theme],
                    () -> showThemeDialog(themes));

                // Information
                new Text(R.string.settings_information_label).modifier(listItemSubtitle());
                settingsRow(R.drawable.ic_information, R.string.settings_version_button, versionName, () -> {
                    versionClickCounter++;
                ...
                settingsRow(R.drawable.ic_share_variant, R.string.settings_share_button, null, () -> {
                    ...
                    intent.putExtra(
                        Intent.EXTRA_TEXT, context.getString(R.string.settings_share_message, STORE_PAGE_URL));
                    context.startActivity(Intent.createChooser(intent, null));
                });
                settingsRow(
                    R.drawable.ic_account_supervisor, R.string.settings_about_button, null, this::showAboutDialog);

                // Footer
                new Text(R.string.settings_footer_button)
                    .modifier(listItemFooter())
                    .onClick(() -> context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(ABOUT_WEBSITE_URL))));
    ...
    private void showCurrencyDialog(String[] currencies) {
        var dialog = new AlertDialog.Builder(getContext())
                         .setTitle(R.string.settings_currency_button)
                         .setSingleChoiceItems(currencies, currency,
                             (d, which) -> {
                                 d.dismiss();
                                 if (currency != which) {
                                     currency = which;
    ...
    private void showAboutDialog() {
        new AlertDialog.Builder(getContext())
            ...
            .setNegativeButton(R.string.settings_about_alert_website_button,
                (d, which) -> getContext().startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(ABOUT_WEBSITE_URL))))
