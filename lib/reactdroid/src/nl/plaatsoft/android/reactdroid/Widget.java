...
abstract public class Widget {
        ...
        public Widget paddingDp(float padding) {
                paddingTop = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, padding,
        ...
        public Widget paddingDp(float paddingVertical, float paddingHorizontal) {
                paddingTop = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, paddingVertical,
                                context.getContext().getResources().getDisplayMetrics());
                paddingRight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, paddingHorizontal,
                                context.getContext().getResources().getDisplayMetrics());
                paddingBottom = paddingTop;
        ...
        public Widget paddingDp(float paddingTop, float paddingRight, float paddingBottom) {
                this.paddingTop = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, paddingTop,
                                context.getContext().getResources().getDisplayMetrics());
                this.paddingRight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, paddingRight,
                                context.getContext().getResources().getDisplayMetrics());
                this.paddingBottom = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, paddingBottom,
                                context.getContext().getResources().getDisplayMetrics());
        ...
        public Widget paddingDp(float paddingTop, float paddingRight, float paddingBottom, float paddingLeft) {
                ...
                this.paddingBottom = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, paddingBottom,
                                context.getContext().getResources().getDisplayMetrics());
                this.paddingLeft = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, paddingLeft,
                                context.getContext().getResources().getDisplayMetrics());
                return this;
        }
